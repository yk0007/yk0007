<a href="https://yk0007.pages.dev" target="_blank" rel="noopener noreferrer">
...
| **🛢️ Databases/Platforms** | ![Databases](https://go-skill-icons.vercel.app/api/icons?i=mongodb,postgres,firebase,supabase) <br> <sub>• WatermelonDB</sub> |
| **🧰 Developer Tools**   | ![Tools](https://go-skill-icons.vercel.app/api/icons?i=git,github,docker,vscode) <br> <sub>• Google Colab</sub>           |
